...
// output the column headings
	fputcsv($output, array('Reference ID', 'Date', 'Item', 'Type', 'Class', 'Locale', 'Card #', 'Card Type', 'Before Tax', 'Tax', 'Total', 'Name', 'Age', 'Address', 'City', 'Province', 'Postal', 'Redeem Date', 'Transaction', 'Email'));
...
fputcsv($output, array($id, $date, $cat, $typ[$itemid], $idd[$itemid], $kiosk, $cnumb, $ctype, $amount, $tax, $amount2, $name, $age, $address, $city, $province, $postal, $redeem, 'purchase', $email));	
	$i++;
}
