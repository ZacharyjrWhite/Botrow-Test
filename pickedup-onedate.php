...
<p>
 ...
 <a href="javascript:items('Anyday');">Show Anyday Tickets</a>
</p>
...
<br/><br/><table width="1000" class="cool" align="center"><tr><td align="center"><font face="more" size="6"><b>Tickets: <span id="count">0</span></b></font>
</td></tr></table>
...
<script type="text/javascript">
 $('.popupCloseButton').click(function(){
	...
	function report(){
		...
		window.open('reports5.php?go=yes&date='+ dw +'', '_top')
...
location.reload();
                            ...
                            $('#items').append('<br/><br/><br/>No Tickets Ordered!<br/><br/>');
...
html += '<div title="'+ redeemdate +' '+ vaft +' - '+ vbef +'" style="font-size: 12px; height:14px; line-height:14px; overflow:hidden; color:#808080; font-weight:600;"><span class="hlite2" id="RD'+ id +'">Valid: '+ redeemdate +'</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="display: inline-block; width:110px;">'+ vaft +' - '+ vbef +'</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="lookup.php?id='+refid+'">OID: '+refid+'</a></div>';
