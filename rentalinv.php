...
if(isset($_REQUEST['id']) and $_REQUEST['id'] > 0) {
	...
	$aa6 = mysqli_query($db,"SELECT * FROM rentalinv where id like '$id' and del is NULL");   
...
<?php	
	...
	$title=utf8_encode(mysqli_result($aa6,0,"title"));	
...
<textarea class = "daa1" id = "nam"  placeholder="Ex: Women's 10" alt="Ex: Women's 10" title="Ex: Women's 10"></textarea>
</td>
<td width = "300" valign="center" align="center">
<textarea class = "daa1" id = "num"  placeholder="Ex: 20" alt="Ex: 20" title="Ex: 20"></textarea>
</td>
...
<br/><br/><table width="800" class="cool" align="center"><tr><td align="center"><font face="more" size="6"><b><?php echo $title; ?> Inventory:</b></font>
</td></tr></table>
<div id="items"></div>
</center>
...
$("#add").click(function(){
	...
	$('#num').css({'border':'1px solid #e2e2e2'});
...
var num = parseFloat(Math.round(num * 100) / 100).toFixed(0);	
...
if (isNaN(num)){
	  ...
	  alert('Item Added!');	
   	  ...
   	  $( "#items" ).load( "/rentalinv2.php?id="+ phpid +"", function( response, status, xhr ) {
  if ( status == "error" ) {
//var msg = "Sorry but there was an error: ";
    //alert( msg + xhr.status + " " + xhr.statusText );
