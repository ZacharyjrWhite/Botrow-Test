...
<head>
  <meta charset="utf-8">
  <title>Botrow - Weekly Promo</title>
...
$aa = mysqli_query($db,"SELECT * FROM items where id = '$ids' and del is NULL and master is NULL and itemtype = 'weekly' order by ord asc");   
...
$aa6 = mysqli_query($db,"SELECT * FROM inventory where del is NULL order by name asc");   
$bb6 = mysqli_num_rows($aa6);
$aa = mysqli_query($db,"SELECT * FROM items where master = '$ids' and itemtype='weekly' and del is NULL order by ord asc");   
$bb = mysqli_num_rows($aa);
...
function added(we){
    ...
    location.href = '/promo.php?id='+idd+'';
			...
			success:function(data){
				...
				if (data == '2'){
					alert('Error!');
					  ...
					  location.href = '/promo.php?id=<?php echo $ids; ?>';
