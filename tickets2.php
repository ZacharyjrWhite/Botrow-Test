...
$aa = mysqli_query($db,"SELECT * FROM items where soldon like '$day' and del is NULL and master is NULL and itemtype = 'weekly' order by ord asc");   
...
<td width = "100" valign="center" align="center">
<div class = "buton3" id = "add" onclick="window.open('promo.php?id=<?php echo $id; ?>', '_top')">
<?php 
if ($promo == NULL){
	?>
Add	
