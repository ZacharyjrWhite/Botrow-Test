...
<head>
  <meta charset="utf-8">
  <title>Botrow - Promo Codes</title>
...
<textarea class = "daa2" id = "nam"  placeholder="Ex: StaffDiscount" alt="Ex: StaffDiscount" title="Ex: StaffDiscount"></textarea>
</td>
<td width = "300" valign="center" align="center">
<textarea class = "daa2" id = "num"  placeholder="Ex: 20" alt="Ex: 20" title="Ex: 20"></textarea>
</td>
...
<br/><br/><table width="800" class="cool" align="center"><tr><td align="center"><font face="more" size="6"><b>Promo Codes:</b></font>
</td></tr></table>
<div id="items"></div>
</center>
...
//var msg = "Sorry but there was an error: ";
  ...
  location.href = '/pcodes.php';
	  ...
	  alert('There is already a promo code with that name!');	
